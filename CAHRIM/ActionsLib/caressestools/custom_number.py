...
class CustomNumber():
    ...
    def selectnumber(self):
        ...
        self.app = 'customnumber'
        self.event = 'CARESSES/CustomNumber/number'
        return self.run()
    ...
    def run(self):
        ...
        onExit = self.sMemory.subscriber('CARESSES/CustomNumber/exit')
        idExit = onExit.signal.connect(functools.partial(self.onExitReceived, 'CARESSES/CustomNumber/exit'))
    ...
    def onTouch(self, msg, value):
        self.sMemory.raiseEvent("CARESSES/CustomNumber/exit", True)
...
if __name__ == "__main__":
    ...
    cn = CustomNumber(session)
    try:
        print(cn.selectnumber())
        time.sleep(2)
