...
import otherlibs.six as six
from otherlibs.six.moves import zip
...
from otherlibs.six import BytesIO
from otherlibs.six.moves import http_client
from otherlibs.six.moves.urllib.parse import urlencode, urlparse, urljoin, \
...
import uritemplate as uritemplate
#
# Local imports
