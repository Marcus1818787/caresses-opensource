...
## Action "Privacy Turn Around".
#
#  Pepper provides privacy to the user by turning around and looking somewhere.
class PrivacyTurnAround(Privacy):
    ...
    def __init__(self, apar, cpar, session, asr):
        ...
        self.animationTag = self.HIDE_TURN_TAG
        self.angle = self.ANGLE_TURN_AROUND
...
if __name__ == "__main__":
    ...
    action = PrivacyTurnAround(apar, cpar, session, "normal")
