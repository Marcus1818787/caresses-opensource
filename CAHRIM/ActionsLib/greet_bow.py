...
## Action "Greet Bow".
#
#  Pepper greets the user with a bow.
class GreetBow(Greet):
    ...
    def __init__(self, apar, cpar, session):
        ...
        self.content = self.sp.script["Greet"]["other"]["0"][self.languageTag.lower()].replace("$USERNAME$", self.username)
