...
## Action "Greet Namaste".
#
#  Pepper greets the user with the Namaste gesture.
class GreetNamaste(Greet):
    ...
    def __init__(self, apar, cpar, session):
        ...
        self.animationTag = self.NAMASTE_TAG
        ...
        self.content = self.sp.script["Greet"]["other"]["1"][self.languageTag.lower()].replace("$USERNAME$", self.username)
