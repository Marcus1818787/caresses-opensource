...
## Action "Privacy Look Down".
#
#  Pepper provides privacy to the user by looking down.
class PrivacyLookDown(Privacy):
...
if __name__ == "__main__":
    ...
    action = PrivacyLookDown(apar, cpar, session, "normal")
