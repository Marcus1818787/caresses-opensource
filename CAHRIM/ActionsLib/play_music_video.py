...
## Action "Play Music Video".
#
#  Pepper shows a music video from YouTube on its tablet.
#  This action requires the installation of the NAOqi app PlayYouTube.
class PlayMusicAndVideo(YouTubeTv):
    ...
    def __init__(self, apar, cpar, session, asr):
        ...
        self.subaction = "MUSIC"
        self.params = self.loadParameters("music.json")
